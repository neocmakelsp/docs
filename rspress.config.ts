    ...
    socialLinks: [
      {
        icon: 'github',
        mode: 'link',
        content: 'https://github.com/neocmakelsp/neocmakelsp',
      },
      {
        icon: {
          svg: `
            <!--- This logo is the trademark of The Matrix.org Foundation. Use of this logo does not imply endorsement or affiliation. --->
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
              viewBox="0 0 520 520" style="enable-background:new 0 0 520 520;" xml:space="preserve" fill="currentColor">
        ...
        mode: 'link',
        content: 'https://matrix.to/#/!wqKdajPSKyqqLoFnlA:mozilla.org?via=mozilla.org&via=matrix.org',
      },
    ],
  },
});
