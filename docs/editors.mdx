...
The [`neovim/nvim-lspconfig`](https://github.com/neovim/nvim-lspconfig) plugin has a
...
As of version 25.07 Helix has built-in support for `neocmakelsp` and doesn't
